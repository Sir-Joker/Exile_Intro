...
uiNameSpace setVariable ["ExileClient_gui_loadingScreen_load",
{
	...
	switch (_displayType) do 
	{
		...
		{
			_spinnerTextControl ctrlSetStructuredText (parseText "<t>Joining the chaos...</t>");
		};

		case "RscDisplayClient":
		{
			_spinnerTextControl ctrlSetStructuredText (parseText "<t>Connecting to Hello Kitty Online...</t>");
		};

		case "RscMPSetupMessage":
		{
			_spinnerTextControl ctrlSetStructuredText (parseText "<t>Downloading Virus...</t>");
		};
		...
		default
		{
			...
			{
				_loadingText = "<t>Enemy Island Development: </t><t color='#c72651'>www.enemy-island.com</t>";
			}
			else 
			{
				...
				_loadingText = format ["<t>%1</t> <t size='0.5' color='#c72651' valign='bottom'> %2</t>", _loadingTextTemplate select 0, _loadingTextTemplate select 1];
			};
	...
	if (_backgroundPicture isEqualTo false) then 
	{
		...
		[
			"EISL_assets\loading\eisl1.paa",
			"EISL_assets\loading\eisl2.paa",
			"EISL_assets\loading\eisl3.paa",
			"EISL_assets\loading\eisl4.paa",
			"EISL_assets\loading\eisl5.paa",
			"EISL_assets\loading\eisl6.paa",
			"EISL_assets\loading\eisl7.paa",
			"EISL_assets\loading\eisl8.paa",
			"EISL_assets\loading\eisl9.paa",
			"EISL_assets\loading\eisl10.paa",
			"EISL_assets\loading\eisl11.paa",
			"EISL_assets\loading\eisl12.paa"
			//"EISL_assets\loading\start.paa"
		];	
